...
// in simulator we redefine to format for SweetBrown Developer console
...
{\
	NSString * exceptionName = [@"org.sweetbrown." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sweetbrown";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISweetBrownNativeItemNone = -1, 
	UISweetBrownNativeItemSpinner = -2,
	UISweetBrownNativeItemProgressBar = -3,
	
	UISweetBrownNativeItemSlider = -4,
	UISweetBrownNativeItemSwitch = -5,
	UISweetBrownNativeItemMultiButton = -6,
	UISweetBrownNativeItemSegmented = -7,
	
	UISweetBrownNativeItemTextView = -8,
	UISweetBrownNativeItemTextField = -9,
	UISweetBrownNativeItemSearchBar = -10,
	
	UISweetBrownNativeItemPicker = -11,
	UISweetBrownNativeItemDatePicker = -12,
	
	UISweetBrownNativeItemInfoLight = -13,
	UISweetBrownNativeItemInfoDark = -14,
	
	UISweetBrownNativeItemDisclosure = -15,
	
	UISweetBrownNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SweetBrown instances of
