 ...
 * Copyright (c) 2009-2011 by SweetBrown, Inc. All Rights Reserved.
...
//@interface SweetBrownObject : NSObject
//@end

@interface SweetBrownObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SweetBrownObject class]])
		{
			for (NSString *key in [[(SweetBrownObject*)o modules] allKeys])
			{
