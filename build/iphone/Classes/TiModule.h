...
/**
 The base class for all SweetBrown modules
 */
...
/**
 SweetBrown Platform calls this method on startup.
 */
-(void)startup;

/**
 SweetBrown Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SweetBrown Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SweetBrown Platform calls this method on resume.
 @param sender The sender of the event.
 */
