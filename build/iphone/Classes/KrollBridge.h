...
@interface SweetBrownObject : KrollCoverageObject {
#else
@interface SweetBrownObject : KrollObject {
#endif
@private
...
extern NSString * SweetBrown$ModuleRequireFormat;
